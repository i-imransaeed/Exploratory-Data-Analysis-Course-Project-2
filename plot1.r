...
sumByYear <- aggregate(Emissions ~ year, emissionsData, sum)

barplot(height=sumByYear$Emissions, names.arg=sumByYear$year, xlab="Years", ylab=expression('Total PM'[2.5]*' emission'),main=expression('Total PM'[2.5]*' emissions at various years'))
